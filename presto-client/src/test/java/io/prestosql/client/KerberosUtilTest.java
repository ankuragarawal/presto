...
public class KerberosUtilTest
{
    ...
    @Test
    public void testResolveMultipleAlias() throws NamingException
    {
        assertEquals(SERVICE_NAME_VALUE, KerberosUtil.resolve(HOST, ictx));
    }

    @Test
    public void testResolveNoAlias() throws NamingException
    {
    ...
    {
        KerberosUtil.resolve(HOST_NOMAPPING, ictx);
    }
}
